...
F_COLS_TO_HIDE = [FOOD_ID_COL, PRICE_COL, PER_COL, PRICE_QUANTITY_COL, PRICE_UNIT_COL, MIN_COL,
                  MIN_UNIT_COL, MAX_COL, MAX_UNIT_COL, TARGET_COL, TARGET_UNIT_COL, SELECTABLE_UNITS_COL, NUT_QUANT_COL]
P_COLS_TO_HIDE = [FOOD_ID_COL, NAME_COL, MIN_COL, MIN_UNIT_COL, MAX_COL,
                  MAX_UNIT_COL, TARGET_COL, TARGET_UNIT_COL, SELECTABLE_UNITS_COL, NUT_QUANT_COL]
C_COLS_TO_HIDE = [FOOD_ID_COL, NAME_COL, PRICE_COL, PER_COL,
                  PRICE_QUANTITY_COL, PRICE_UNIT_COL, SELECTABLE_UNITS_COL, NUT_QUANT_COL]
