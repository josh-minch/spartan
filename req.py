...
min = {
( 0, 'm') : [0.7,60,None,31,4.4,0.5,9.1,200,0.2,10,0.27,30,0.003,100,15,2,400,120,400,40,10,4,2,0.2,0.3,2,0.1,65,0.4,1.7,125],
(0.5, 'm'): [0.8,95,None,30,4.6,0.5,11,260,0.22,500,11,75,0.6,275,20,3,700,370,500,50,10,5,3,0.3,0.4,4,0.3,80,0.5,1.8,150],
( 1, 'm') : [1.3,130,19,None,7,0.7,13,700,0.34,700,7,80,1.2,460,20,3,3000,1000,300,15,15,6,30,1,0.5,6,0.5,150,0.9,2,200],
( 4, 'm') : [1.7,130,25,None,10,0.9,19,1000,0.44,1000,10,130,1.5,500,30,5,3800,1200,400,25,15,7,55,1,0.6,8,0.6,200,1.2,3,250],
...
( 0, 'f') : [0.7,60,None,31,4.4,0.5,9.1,200,0.2,10,0.27,30,0.003,100,15,2,400,120,400,40,10,4,2,0.2,0.3,2,0.1,65,0.4,1.7,125],
(0.5, 'f'): [0.8,95,None,30,4.6,0.5,11,260,0.22,500,11,75,0.6,275,20,3,700,370,500,50,10,5,3,0.3,0.4,4,0.3,80,0.5,1.8,150],
( 1, 'f') : [1.3,130,19,None,7,0.7,13,700,0.34,700,7,80,1.2,460,20,3,3000,1000,300,15,15,6,30,1,0.5,6,0.5,150,0.9,2,200],
( 4, 'f') : [1.7,130,25,None,10,0.9,19,1000,0.44,1000,10,130,1.5,500,30,5,3800,1200,400,25,15,7,55,1,0.6,8,0.6,200,1.2,3,250],
...
def get_min(age_range, sex):
    return [{'name': name, 'min': min} for (name, min) in zip(nut_names, min[(age_range, sex)])]

def calculate_age_range(bd_year, bd_month, bd_day):
    age = calculate_age(bd_year, bd_month, bd_day)
    for i, ar in enumerate(age_range):
        if age < ar: 
            return age_range[i-1]
