...
#
# Created: Tue Sep  3 02:26:49 2019
...
class Ui_RequirementsWindow(object):
    def setupUi(self, RequirementsWindow):
        ...
        self.gridLayout.addWidget(self.buttonBox, 5, 17, 1, 1)
        self.req_view = QtWidgets.QTableView(RequirementsWindow)
        self.req_view.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.req_view.setShowGrid(False)
        self.req_view.setObjectName("req_view")
        self.gridLayout.addWidget(self.req_view, 4, 0, 1, 18)
        ...
        self.gridLayout.addWidget(self.label_2, 2, 0, 1, 13)
        ...
        self.gridLayout.addWidget(self.cust_edit, 5, 0, 1, 4)
        ...
        RequirementsWindow.setTabOrder(self.cust_edit, self.req_view)
        RequirementsWindow.setTabOrder(self.req_view, self.debug_btn)
